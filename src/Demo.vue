<template>
    <div id="demo">
        ...
        branches' content should go. When you are done merging the branches / features you want, feel free to
        remove all merge slots throughout the project. -->
...
// Merge slot: nimiq-vue-components
// Merge slot: nimiq-hub
import HubInfo from './demo-components/HubInfo.vue';
// Merge slot: nimiq-core
// Merge slot: nimiq-network
// Merge slot: nimiq-browser-warning
// Merge slot: nimiq-utils
...
@font-face {
    ...
    src: local('Muli Regular'), local('Muli-Regular'),
        url(https://fonts.gstatic.com/s/muli/v12/7Auwp_0qiz-afTLGLQ.woff2) format('woff2'),
...
@font-face {
    ...
    src: local('Muli SemiBold'), local('Muli-SemiBold'),
        url(https://fonts.gstatic.com/s/muli/v12/7Au_p_0qiz-ade3iOCX2zw.woff2) format('woff2'),
...
@font-face {
    ...
    src: local('Muli Bold'), local('Muli-Bold'),
        url(https://fonts.gstatic.com/s/muli/v12/7Au_p_0qiz-adYnjOCX2zw.woff2) format('woff2'),
...
@font-face {
    ...
    src: local('Fira Mono Regular'), local('FiraMono-Regular'),
        url(https://fonts.gstatic.com/l/font?kit=N0bX2SlFPv1weGeLZDtQJOz2uefgU6J9MQqzf7dqJ7MEaOcyg_hbyR-8rlSFUkDt1cpb&skey=bb26c8d476ab3f05&v=v8) format('woff2'),
